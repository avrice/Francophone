...
Quiz currentTestE =  quizGenerator(questionsE,answersE);
var answerE;
var wordE;
class Quiz {
...
class EasyTest extends StatefulWidget {
  @override
  _EasyTestState createState() => _EasyTestState();
  void initState () {
        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                "Question : What is the equivalent of '$wordE' ?",
                style: TextStyle(
                  fontFamily: 'Oswald',
                  fontSize: 20.0,
                  fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  answerE = myController.text;
                  expectedAnswerE = currentTestE.answersList[counter];
                  isCorrect = (answerE == currentTestE.answersList[counter]);
                  answerMessage = (isCorrect == true ) ?  "Correct!" : "Sorry, that answer was incorrect.\n The expected answer to this question was $expectedAnswerE.";
                  if (isCorrect == true) {
                    setState(() {
                  ...
                  Future.delayed(const Duration(milliseconds: 2500), () {
                    setState(() {
                      wordE = currentTestE.questionList[counter];
                  ...
                  if (counter == 10){
                    Future.delayed(const Duration(milliseconds: 2650), () {
                      ...
                      setState(() {
                        currentTestE =  quizGenerator(questionsE, answersE);
                      });
                      Navigator.pushReplacementNamed(context, '/es');
                    });
                  }
                },
              ),
