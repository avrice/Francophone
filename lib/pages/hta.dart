...
Quiz currentTestHA =  quizGenerator(questionsHA,answersHA);
var answerHA;
var wordHA;
class Quiz {
...
class HardTestA extends StatefulWidget {
  @override
  _HardTestAState createState() => _HardTestAState();
  void initState () {

  }
}

class _HardTestAState extends State<HardTestA> {
  @override
  void dispose() {
        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                "Question : What is the equivalent of '$wordHA' ?",
                style: TextStyle(
                  fontFamily: 'Oswald',
                  fontSize: 20.0,
                  fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  answerHA = myController.text;
                  expectedAnswerHA = currentTestHA.answersList[counter];
                  isCorrect = (answerHA == currentTestHA.answersList[counter]);
                  answerMessage = (isCorrect == true ) ?  "Correct!" : "Sorry, that answer was incorrect.\n The expected answer to this question was $expectedAnswerHA.";
                  if (isCorrect == true) {
                    setState(() {
                  ...
                  Future.delayed(const Duration(milliseconds: 2500), () {
                    setState(() {
                      wordHA = currentTestHA.questionList[counter];
                  ...
                  if (counter == 10){
                    Future.delayed(const Duration(milliseconds: 2650), () {
                      ...
                      setState(() {
                        currentTestHA =  quizGenerator(questionsHA, answersHA);
                      });
                      Navigator.pushReplacementNamed(context, '/hsa');
                    });
                  }
                },
              ),
