...
var NC;
var expectedAnswer;
var questions = ['rentrer', 'vivre', 'rendre', 'tenir', 'oublier', 'travailler', 'manger', 'entrer', 'devenir', 'commencer', 'payer', 'tirer', 'ouvrir', 'changer', 'excuser', 'dormir', 'occuper', 'marcher', 'envoyer', 'apprendre', 'boire', 'garder', 'montrer', 'asseoir', 'porter', 'prier', 'servir', 'écrire', 'retrouver', 'gagner', 'acheter', 'rappeler', 'lire', 'monter', 'quitter', 'emmener', 'toucher', 'continuer', 'raconter', 'repondre', 'sauver', 'rencontrer', 'fermer', 'valoir', 'compter', 'bouger', 'apporter', 'décider', 'vendre', 'expliquer',];
...
Quiz currentTest =  quizGenerator(questions,answers);
var answer;
var word;
class Quiz {
        ...
        child: RaisedButton(
            ...
            child: Center(
              ...
              answer = myController.text;
                  expectedAnswer = currentTest.answersList[counter];
                  isCorrect = (answer == currentTest.answersList[counter]);
                  ...
                  Future.delayed(const Duration(milliseconds: 5000), () {
                    setState(() {
                      word = currentTest.questionList[counter];
                ...
                counter = counter + 1;
                  ...
                  if (counter == 10){
                    Future.delayed(const Duration(milliseconds: 2650), () {
                      ...
                      setState(() {
                        currentTest =  quizGenerator(questions, answers);
                      });
